...
一、首部及导言\n\
欢迎您使用派克宠物临时寄存服务！\n\
为使用派克宠物临时寄存服务（简称为：本服务），您应当阅读并遵守《会员服务协议》（简称为：本协议）。请您务必审慎阅读、充分理解各条款内容，特别是免除或限制责任的相应条款，以及开通或使用某项服务的单独协议，并选择接受或不接受。免除或限制责任条款可能以加粗形式提示您注意。\n\
...
三、关于本服务\n\
　　临时寄存服务，指按照派克的指定方式支付一定购卡服务费用之后，用户可以享有由派克或第三方提供的在派克产品、生活等方面特权的服务，简称为：本服务。\n\
...
7.	关于卫生问题，派克努力做好宠笼的卫生状况，用户在使用前需要先进行消毒处理，然后铺设一张垫纸，服务结束前，需要拿走底部的垫纸，然后关锁结账，直到服务结束。如果未及时清理，遭到下一个客户举报，你会被扣除对应信用分，这对你后期使用服务有很大影响；\n\
8.	使用前无法开锁，或发现宠笼故障时，请联系客户处理，宠笼门口有联系方式，或及时在系统上报；\n\
9.	使用过程中无法开锁关锁时，无法结账时，请联系客服处理，及时上报遇到的情况；\n\
服务过程中遇到突发情况？\n\
派克列举了一下，并给出解决方案：\n\
1.	如果用户存放宠物时间过长，超过4小时，平台会给用户打电话，提醒用户，如果联系不上，仍然存放在笼子内，派克有权作出对应决策，并且如果宠物有什么问题，后果由使用者承担；\n\
