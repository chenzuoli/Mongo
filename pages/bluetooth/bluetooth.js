...
Page({
      ...
      success: function(res) {
        for (var i = 0; i < res.characteristics.length; i++) {
          if (res.characteristics[i].properties.notify) {
            ...
            console.log("----notified----" + that.data.services[i].uuid)
            console.log("----notified----" + res.characteristics[i].uuid)
          }
          if (res.characteristics[i].properties.write) {
            ...
            console.log("----can write----" + that.data.services[i].uuid)
            console.log("----can write----" + res.characteristics[i].uuid)
          }
          ...
          //     readCharacteristicsId: res.characteristics[i].uuid,
          //   })
          //   console.log("----can read----" + that.data.services[i].uuid)
          //   console.log("----can read----" + res.characteristics[i].uuid)
          // }
        }
  ...
  bluetooth8: function(e) {
    ...
    console.log("-------------" + ab2str(str2ab("open")) + "-----调用notify开始")
    this.bluetooth9()
  ...
  bluetooth10: function() {
    ...
    console.log(ab2hex(that.data.value))
